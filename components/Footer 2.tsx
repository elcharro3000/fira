    ...
    <footer className="relative py-12 px-4 border-t border-peach/20">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* Social */}
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-sm text-warm-gray">
            <a
              href="https://www.instagram.com/firawellnessclub/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex min-h-11 items-center gap-2 hover:text-coral transition-colors"
            >
        ...
        <div className="mt-6 text-center">
          <a
            href="/terminos"
            className="text-xs text-warm-gray/40 transition-colors hover:text-warm-gray/60"
          >
        ...
        {/* Copyright */}
        <div className="mt-4 pt-6 border-t border-peach/15 text-center">
