      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <a
              href="https://www.instagram.com/firastudio/"
              target="_blank"
              rel="noopener noreferrer"
          ...
          >
            ...
            <div className="mt-8 rounded-xl overflow-hidden h-48 bg-rose-glow/30 flex items-center justify-center">
              <iframe
                title="FIRA Wellness Club Polanco"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3762.661!2d-99.197!3d19.432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTnCsDI1JzU1LjIiTiA5OcKwMTEnNDkuMiJX!5e0!3m2!1ses!2smx!4v1"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
